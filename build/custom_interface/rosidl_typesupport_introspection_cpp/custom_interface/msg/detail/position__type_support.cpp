...
{
  new (message_memory) custom_interface::msg::Position(_init);
}

void Position_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interface::msg::Position *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Position_message_member_array[1] = {
  {
    ...
    offsetof(custom_interface::msg::Position, position),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Position_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interface::msg::Position),
...
{
  return &::custom_interface::msg::rosidl_typesupport_introspection_cpp::Position_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interface, msg, Position)() {
  return &::custom_interface::msg::rosidl_typesupport_introspection_cpp::Position_message_type_support_handle;
}
