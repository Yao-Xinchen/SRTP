...
#include "custom_interface/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interface::msg::Position & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interface::msg::Position & ros_message)
{
  // Member: position
  cdr >> ros_message.position;
...
{
  auto typed_message =
    static_cast<const custom_interface::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interface::msg::Position *>(
    untyped_ros_message);
...
{
  return &custom_interface::msg::typesupport_fastrtps_cpp::_Position__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, msg, Position)() {
  return &custom_interface::msg::typesupport_fastrtps_cpp::_Position__handle;
}
