...
{
  new (message_memory) custom_interface::msg::Torque(_init);
}

void Torque_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interface::msg::Torque *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Torque_message_member_array[1] = {
  {
    ...
    offsetof(custom_interface::msg::Torque, torque),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Torque_message_members = {
  ...
  "Torque",  // message name
  1,  // number of fields
  sizeof(custom_interface::msg::Torque),
...
{
  return &::custom_interface::msg::rosidl_typesupport_introspection_cpp::Torque_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interface, msg, Torque)() {
  return &::custom_interface::msg::rosidl_typesupport_introspection_cpp::Torque_message_type_support_handle;
}
